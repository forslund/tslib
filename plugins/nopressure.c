 ...
 *
 *  Modified version of the linux raw input plugin providing 
 *  basic functionality for devices that don't provide pressure
 *  information.
 *  Copywight (C) 2012 Åke Forslund
 *
